...
class CardTask(models.Model):
    ...
    time_start = models.DateTimeField(verbose_name='Начало', blank=True)
    time_end = models.DateTimeField(verbose_name='Завершение', blank=True)
    ...
    def get_absolute_url(self):
        return reverse('edit_task', kwargs={'task_id': self.pk})
